          ...
          <div className="flex flex-wrap items-center justify-between gap-4 xs:gap-6 py-4 xs:py-6 border-y border-slate-100">
            <div className="flex items-center gap-3 xs:gap-4">
              <Link to={`/blog/author/${article.author.slug}`} className="group relative">
                <div className="w-10 xs:w-12 sm:w-14 h-10 xs:h-12 sm:h-14 rounded-full bg-emerald-100 flex items-center justify-center text-primary font-bold text-lg xs:text-xl border-3 xs:border-4 border-white shadow-md group-hover:scale-105 transition-transform">
